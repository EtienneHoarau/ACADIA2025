...
encoder_model_path = 'encoder//conv_aeDebruiteur_model_encoder'  # à ajuster avec ton chemin
decoder_model_path = 'decoder//conv_aeDebruiteur_model_decoder'  # à ajuster avec ton chemin
...
class ImageApp(QWidget):
    ...
    def initUI(self):
        ...
        self.select_button = QPushButton('Sélectionner une image Mnist à débruiter', self)
    ...
    def select_image(self):
        # Ouvrir une boîte de dialogue pour sélectionner une image
        options = QFileDialog.Options()
        file_path, _ = QFileDialog.getOpenFileName(self, "Sélectionner une image Mnist à débruiter", "", "Images (*.png *.jpg *.jpeg *.bmp)", options=options)
        if file_path:
